      ...
      <div className="container navbar-container">
        ...
        <div className="nav-links">
          ...
          <button 
            ...
            className={`nav-link-btn ${activeTab === 'module3' ? 'active' : ''}`}
          >
            Module 3
          </button>
          <button 
            onClick={() => setActiveTab('module4')} 
            className={`nav-link-btn ${activeTab === 'module4' ? 'active' : ''}`}
          >
            Module 4
          </button>
          <button 
            onClick={() => setActiveTab('module5')} 
            className={`nav-link-btn ${activeTab === 'module5' ? 'active' : ''}`}
          >
            Module 5
          </button>
          <button 
            onClick={() => setActiveTab('module6')} 
            className={`nav-link-btn ${activeTab === 'module6' ? 'active' : ''}`}
          >
            Module 6
          </button>
          <button 
            onClick={() => setActiveTab('module7')} 
            className={`nav-link-btn ${activeTab === 'module7' ? 'active' : ''}`}
          >
            Module 7
          </button>
          <button 
